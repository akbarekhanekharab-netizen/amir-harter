...
<body>
    ...
    <div class="modal-overlay" id="aboutModal">
        <div class="modal">
            <div class="modal-header">
                <span data-fa="📖 درباره ما" data-en="📖 About Us">📖 درباره ما</span>
                <button class="modal-close" onclick="closeModal('aboutModal')">›</button>
            </div>
            <p data-fa="AmirHarter | پورتال هوشمند" data-en="AmirHarter | Smart Portal">AmirHarter | پورتال هوشمند</p>
            <br>
            <p data-fa="AMIRHARTER ... فقط یک سایت نیست" data-en="AMIRHARTER ... not just a website">AMIRHARTER ... فقط یک سایت نیست</p>
            <p data-fa="یه دنیای کامله!" data-en="It's a whole world!">یه دنیای کامله!</p>
            <br>
            <p data-fa="جایی که همه‌چیز یکجا جمع شده" data-en="Everything in one place">جایی که همه‌چیز یکجا جمع شده</p>
            <p data-fa="از آخرین اخبار و قیمت ارز" data-en="From latest news and currency rates">از آخرین اخبار و قیمت ارز</p>
            <p data-fa="تا آب و هوا، فوتبال و ترجمه!" data-en="To weather, football and translation!">تا آب و هوا، فوتبال و ترجمه!</p>
            <br>
            <p data-fa="ساخته شده برای اینکه دنیایی از اطلاعات دم دستت باشه" data-en="Made so you have a world of information at your fingertips">ساخته شده برای اینکه دنیایی از اطلاعات دم دستت باشه</p>
            <br>
            <p data-fa="✨ قدرت در عین سادگی ✨" data-en="✨ Power in simplicity ✨">✨ قدرت در عین سادگی ✨</p>
            <p data-fa="نسخه ۴.۰" data-en="Version 4.0">نسخه ۴.۰</p>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="reportModal">
        <div class="modal">
            <div class="modal-header">
                <span data-fa="⚠️ گزارش مشکل" data-en="⚠️ Report Issue">⚠️ گزارش مشکل</span>
                <button class="modal-close" onclick="closeModal('reportModal')">›</button>
            </div>
            <p data-fa="در روبیکا پیام دهید:" data-en="Message us on Rubika:">در روبیکا پیام دهید:</p>
            <br>
    ...
    <div class="modal-overlay" id="fontModal">
        <div class="modal">
            <div class="modal-header">
                <span data-fa="🔤 انتخاب فونت" data-en="🔤 Font Size">🔤 انتخاب فونت</span>
                <button class="modal-close" onclick="closeModal('fontModal')">›</button>
            </div>
            <div class="settings-item" onclick="setFontSize('0.9rem', 'کوچیک')" data-fa="کوچیک" data-en="Small">کوچیک</div>
            <div class="settings-item" onclick="setFontSize('1rem', 'متوسط')" data-fa="متوسط" data-en="Medium">متوسط</div>
            <div class="settings-item" onclick="setFontSize('1.2rem', 'بزرگ')" data-fa="بزرگ" data-en="Large">بزرگ</div>
        </div>
    </div>
    ...
    <div class="main">
        ...
        <div class="search-container">
            <button class="search-btn" onclick="searchGoogle(document.getElementById('mainSearch').value)" data-fa="جستجو" data-en="Search">جستجو</button>
            <button class="mic-btn" onclick="voiceSearch()">🎤</button>
            <input class="search-box" id="mainSearch" placeholder="در AMIR HARTER" data-placeholder-fa="در AMIR HARTER" data-placeholder-en="Search in AMIR HARTER">
        </div>

        <div class="search-options">
            <a href="https://play.google.com/" target="_blank" class="search-option" data-fa="📱 گوگل‌پلی" data-en="📱 Google Play">📱 گوگل‌پلی</a>
            <a href="https://telewebion.com/" target="_blank" class="search-option" data-fa="📺 تلوبیون" data-en="📺 Telewebion">📺 تلوبیون</a>
            <a href="games.html" class="search-option" data-fa="🎮 بازی‌ها" data-en="🎮 Games">🎮 بازی‌ها</a>
        </div>
        ...
        <div class="card">
            <div class="card-title" data-fa="🌤 آب و هوا" data-en="🌤 Weather">🌤 آب و هوا</div>
            <div class="weather-card" id="weatherData">{weather_html}</div>
            <select class="province-select" onchange="changeProvince(this.value)">
                <option value="" data-fa="انتخاب استان..." data-en="Select province...">انتخاب استان...</option>
                {provinces_options}
            </select>
        </div>

        <div class="card">
            <div class="card-title"><span class="currency-icon">💱</span> <span data-fa="قیمت ارز" data-en="Currency Rates">قیمت ارز</span></div>
        ...
        <div class="card">
            <div class="card-title" data-fa="⚽ بازی‌های داغ" data-en="⚽ Hot Matches">⚽ بازی‌های داغ</div>
            <div class="filter-btns">
                <button class="filter-btn active" onclick="filterMatches('all', this)" data-fa="همه" data-en="All">همه</button>
                <button class="filter-btn" onclick="filterMatches('finished', this)" data-fa="پایان یافته" data-en="Finished">پایان یافته</button>
                <button class="filter-btn" onclick="filterMatches('live', this)" data-fa="در حال انجام" data-en="Live">در حال انجام</button>
                <button class="filter-btn" onclick="filterMatches('upcoming', this)" data-fa="برگزار نشده" data-en="Upcoming">برگزار نشده</button>
            </div>
            <div class="football-scroll">{matches_html}</div>
        </div>

        <div class="card">
            <div class="card-title" data-fa="📰 آخرین اخبار" data-en="📰 Latest News">📰 آخرین اخبار</div>
            <div class="news-scroll">{news_html}</div>
        </div>

        <div class="card">
            <div class="card-title" data-fa="🌐 ترجمه" data-en="🌐 Translate">🌐 ترجمه</div>
            <div class="lang-row">
                <div class="lang-box">
            ...
            <div class="result" id="result" data-fa="نتیجه ترجمه..." data-en="Translation result...">نتیجه ترجمه...</div>
            <div class="btn-row">
                <button class="translate-btn" onclick="translateText()" data-fa="ترجمه" data-en="Translate">ترجمه</button>
                <button class="copy-btn" onclick="copyResult()" data-fa="کپی" data-en="Copy">کپی</button>
            </div>
        </div>
    ...
    <script>
        ...
        function toggleLanguage() {{
            ...
            document.querySelectorAll('[data-placeholder-fa]').forEach(el => {{
                if (currentLang === 'en' && el.getAttribute('data-placeholder-en')) {{
                    el.placeholder = el.getAttribute('data-placeholder-en');
                }} else {{
                    el.placeholder = el.getAttribute('data-placeholder-fa');
                }}
            }});
        }}
